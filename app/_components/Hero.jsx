...
function Hero() {
  return (
    <div className="relative" id="home">
        ...
        <div className="relative pt-36 ml-auto">
          <div className="lg:w-2/3 text-center mx-auto">
            <h1 className="text-gray-900 dark:text-white font-bold text-5xl md:text-6xl xl:text-7xl">
              Loop is where <span className="text-primary dark:text-white">work happens, in sync.</span>
            </h1>
      ...
      {/* Footer */}
      <footer className="mt-10 py-4 text-center bg-gray-100 dark:bg-gray-800">
        <p className="text-gray-600 dark:text-gray-300">© Piyush</p>
      </footer>
    </div>
  );
}
